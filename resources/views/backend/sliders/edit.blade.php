                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body pt0 pb0">
                        ...
                        <form class="form-horizontal group-border" enctype="multipart/form-data"
                            action="{{route('sliders.update', $slider->id)}}" method="post">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group {{$errors->first('name') ? 'has-error' : ''}}">
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <input type="text" value="{{$slider->note}}" class="form-control" name="note">
                                </div>
                            </div>
                            ...
                            <div class="form-group {{$errors->first('image') ? 'has-error' : ''}}">
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <img src="{{asset('images/sliders/' . $slider->image)}}" width="150px">
                                </div>
                            </div>
                            <div class="form-group {{$errors->first('image') ? 'has-error' : ''}}">
                            ...
                            <a href="{{route('sliders.index')}}" class="btn btn-default pull-left mb10 mt10">
