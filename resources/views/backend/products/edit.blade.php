                        ...
                        <form class="form-horizontal group-border" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="text" value="{{$product->name}}"
                                        name="name">
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <label for="input" class="control-label">Status</label>
                                    <div class="checkbox-custom">
                                        <input type="checkbox" value="{{$product->status}}" id="checkbox1" name="status"
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    @foreach($product->images as $image)
                                        <img width="100px" src="{{asset('images/products/' . $image->url)}}" alt="">
                                    @endforeach
                                </div>
                                <div class="col-lg-12">
                                    <label class="control-label" for="">New Image</label>
                                                ...
                                                <div class="checkbox-custom">
                                                    <input class="check" type="checkbox" name="sizes[]"
                                                        value="{{$size->id}}" id="size-{{$size->id}}"
                                                            @if($ids = $product->sizes->pluck('id')->toArray())
                                                                @foreach ($ids as $size_id)
                                                                    {{ $size->id == $size_id ? 'checked' : '' }}
                                                                @endforeach
                                                            @endif
                                                        >
                                                ...
                                                <div class="checkbox-custom">
                                                    <input class="check" type="checkbox" name="colors[]"
                                                        value="{{$color->id}}" id="color-{{$color->id}}"
                                                            @if($ids = $product->colors->pluck('id')->toArray())
                            ...
                            <a href="{{route('products.index')}}" class="btn btn-default pull-left mb10 mt10">
